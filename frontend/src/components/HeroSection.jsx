...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center min-h-screen'>
      <img src={assets.marvelLogo} alt="marvel-logo" className='max-h-11 lg:h-11 mt-20'/>
      <h1 className='text-5xl md:text-[70px] md:leading-[80px] font-semibold max-w-[440px] text-white'>Guardians <br/> of the Galaxy</h1>
